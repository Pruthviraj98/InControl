...
unknown_image = face_recognition.load_image_file("arush2.jpg")
...
print("Is the unknown face a picture of Arush? {}".format(results[0]))
print("Is the unknown face a picture of Dhruv? {}".format(results[1]))
